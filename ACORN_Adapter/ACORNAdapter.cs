...
using BH.Adapter;
using BH.Engine.ACORN;

namespace BH.Adapter.ACORN
{
    public partial class ACORNAdapter : BHoMAdapter
    {
        ...
        public ACORNAdapter()
        {
            AdapterId = BH.Engine.ACORN.Convert.AdapterId;   //Sets` the "AdapterId" to "SoftwareName_id". Generally stored as a constant string in the convert class in the SoftwareName_Engine
